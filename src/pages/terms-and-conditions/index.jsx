  ...
  return (
    <>
      ...
      <p className={styles.informations}>
        ...
        conditions of your use of the airneis.com website (“Website” or
        ...
        “you” or “your”) and ÀIRNEIS (“ÀIRNEIS”, “we”, “us” or “our”). If you
        ...
        and ÀIRNEIS, even though it is electronic and is not physically signed
        by you, and it governs your use of the Website and Services.
      </p>
      <h2 className={styles.titleInformations}>Accounts and membership</h2>
      <p className={styles.informations}>
      ...
      <h2 className={styles.titleInformations}>User content</h2>
      <p className={styles.informations}>
        ...
        have no obligation to, monitor and review the Content on the Website
        submitted or created using our Services by you. You grant us permission
        to access, copy, distribute, store, transmit, reformat, display and
        perform the Content of your user account solely as required for the
        purpose of providing the Services to you. You also grant us the license
      ...
      <h2 className={styles.titleInformations}>Backups</h2>
      <p className={styles.informations}>
      ...
      <h2 className={styles.titleInformations}>Links to other resources</h2>
      <p className={styles.informations}>
      ...
      <h2 className={styles.titleInformations}>Intellectual property rights</h2>
      <p className={styles.informations}>
        ...
        transfer to you any intellectual property owned by ÀIRNEIS or third
        parties, and all rights, titles, and interests in and to such property
        will remain (as between the parties) solely with ÀIRNEIS. All
        ...
        ÀIRNEIS or its licensors. Other trademarks, service marks, graphics and
        ...
        ÀIRNEIS or third party trademarks.
      </p>
      <h2 className={styles.titleInformations}>Severability</h2>
      <p className={styles.informations}>
      ...
      <h2 className={styles.titleInformations}>Changes and amendments</h2>
      <p className={styles.informations}>
      ...
      <h2 className={styles.titleInformations}>Acceptance of these terms</h2>
      <p className={styles.informations}>
      ...
      <h2 className={styles.titleInformations}>Contacting us</h2>
      <p className={styles.informations}>
      ...
      <p className={styles.informations}>
        This document was last updated on May 7, 2023
      </p>
    </>
  );
};
