...
import { GlobeEuropeAfricaIcon, MapPinIcon as OlMapPinIcon, BuildingOfficeIcon} from "@heroicons/react/24/outline";
...
const AddressCard = (props) => {
  ...
  return (
    <div className={classnames(
      ...
      <p className={styles.title}>{address.mainAddress === true ? "Main address" : `Address ${index}`}</p>
      ...
      {address.mainAddress &&
        <MapPinIcon
          className={styles.mainAddressIcon}
        />
      } 
    </div>
  );
