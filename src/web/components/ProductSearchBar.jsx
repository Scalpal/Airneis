...
const ProductSearchBar = (props) => {
  const { id, placeholder, showSuggestions, closeOverlay, ...otherProps } =
    props;
  ...
  const products =
    !searchLoading && searchData !== null ? searchData.products : [];
    ...
    <div className={styles.container}>
      ...
      <div
        className={classnames(
          ...
          inputFocused && showSuggestions === true
            ? styles.visible
            : styles.hidden,
      ...
      >
        <p className={styles.suggestionsTitle}>
          {searchValue.length === 0 ? "Suggested searches" : "Matching results"}
        </p>
